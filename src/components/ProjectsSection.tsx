        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, i) => (
            ...
            >
              ...
              <div className="p-5">
                <h3 className="text-lg font-bold font-heading text-foreground mb-1">{project.title}</h3>
                ...
                <div className="flex gap-3">
                  <button className="flex items-center gap-1.5 text-xs px-4 py-2 rounded-lg bg-primary/15 text-primary border border-primary/20 hover:bg-primary/25 transition-all">
                    <ExternalLink size={12} /> Live Demo
                  </button>
                  <button className="flex items-center gap-1.5 text-xs px-4 py-2 rounded-lg border border-border text-muted-foreground hover:text-foreground hover:border-primary/30 transition-all">
